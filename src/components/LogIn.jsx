    ...
    <div className="w-full h-screen flex items-center justify-center bg-stone">
      ...
      <div className="text-center mt-4 text-red text-4xl font-medium font-['Poppins']">Log In</div>
        ...
        <div className="mt-4 text-center">
          ...
          <div className="text-center flex justify-end mt-2">
          <Link href="/forgotten" className="text-red text-base font-medium font-['Poppins'] hover:underline active:underline ">Forgotten?</Link>
          </div>
          </div>
          </form>
