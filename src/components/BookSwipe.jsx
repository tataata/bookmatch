    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center">
                <div className="text-center text-black text-4xl font-semibold font-['Poppins'] mb-6">
                    Discover Books
                </div>
                
                    {books.map((book, index) => (
                        <div key={index} className={`${cardClasses} ${expandedBooks[index] ? "h-[930px]" : "h-[775px]"}`}>
                        <div className="justify-center items-center inline-flex w-[430px] h-[390px] top-[45px] absolute rounded-2xl">
                            <img src={book.img} />
                            ...
                            <div className="flex flex-col items-center justify-center gap-2 w-[460px] top-[442px] absolute">
                                ...
                                <div className="justify-start items-start gap-2.5 inline-flex">
                                    {book.tags.map((tag, i) => (
                                        <div key={i} className="py-1 px-3 rounded-xl border border-beige justify-center items-center gap-2.5 flex">
                                            <div className="text-center text-black text-sm font-medium font-['Poppins']">{tag}</div>
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className="px-3 text-black text-base font-normal font-['Lora'] leading-snug mt-1">
                                    {book.description}
                                </div>
                                ...
                                {expandedBooks[index] && (
                                    <div className="flex flex-col items-center justify-center bg-white ">
                                        ...
                                        <div className="flex flex-row gap-16 mb-2">
                                            <div className="text-lg font-medium font-['Lora'] text-left mt-1">Page Count: 
                                            <span className=" text-black text-base font-normal font-['Lora'] leading-snug text-left mb-2 pl-1"> {book.additionalDetails.pages}</span>
                                            </div>

                                            <div className="text-lg font-medium font-['Lora'] text-left mt-1">Language: 
                                            <span className=" text-black text-base font-normal font-['Lora'] leading-snug text-left mb-2 pl-1"> {book.additionalDetails.language}</span>
                                            </div>
                                        </div>

                                            <div className="flex flex-col justify-start">
                                            <div className="text-lg font-medium font-['Lora'] text-left">Author: </div>
                                            <div className=" text-black text-base font-normal font-['Lora'] leading-snug text-left"> {book.additionalDetails.author}</div>
                                            </div>
                                        </div>

                                        {/* <button
                                            className="mt-2 py-2 px-4 rounded-xl text-black font-medium flex flex-row items-center gap-1.5 hover:text-yellow active:text-yellow cursor-pointer"
                                            onClick={() => toggleExpand(index)}
                                            > Close
                                            <svg width="16" height="12" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 5L6 1L11 5" stroke="#151515"/>
                                            </svg>
                                 ...
                                 <button className="w-10 h-10 bg-beige rounded-full flex flex-col justify-center items-center hover:bg-yellow active:bg-yellow cursor-pointer mt-2" onClick={() => toggleExpand(index)}>
                                    <svg
                                        width="24"
                                        height="24"
                                        viewBox="0 0 24 24"
            ...
            <div className="flex flex-col gap-10 items-center justify-center absolute top-[470px] left-[300px]">
                    <button className="w-44 h-44 bg-blue rounded-full flex justify-center items-center">
                    ...
                    <div className="flex flex-col gap-10 items-center justify-center absolute top-[470px] right-[300px] ">
                        <button className="w-44 h-44 bg-red rounded-full flex items-center justify-center">
