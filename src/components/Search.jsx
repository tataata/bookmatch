...
const recommendations = [
    {
        ...
        coverImage: "src/images/BraveNewWorldCover.webp"
    },
    {
...
const Search = () => {
    ...
    return (
        ...
        <div className="flex flex-col gap-4 justify-center items-center">
            ...
            />
              <button>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" className="absolute right-[528px] top-[182px] opacity-50" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="text-black text-lg font-medium font-['Poppins']">Best Sellers </div>
            </button>
            <button className="px-4 p-2 rounded-xl border border-beige justify-center items-center flex hover:bg-beige active:bg-yellow">
            <div className="text-black text-lg font-medium font-['Poppins']">New Releases</div>
            </button>
            <button className="px-4 p-2 rounded-xl border border-beige justify-center items-center flex hover:bg-beige active:bg-yellow">
            <div className="text-black text-lg font-medium font-['Poppins']">Award Winners</div>
            </button>
            <button className="px-4 p-2 rounded-xl border border-beige justify-center items-center flex hover:bg-beige active:bg-yellow">
            <div className="text-black text-lg font-medium font-['Poppins']">Classic Fiction</div>
            </button>
            <button className="px-4 p-2 rounded-xl border border-beige justify-center items-center flex hover:bg-beige active:bg-yellow">
            <div className="text-black text-lg font-medium font-['Poppins']">Adventure</div>
            </button>
            <button className="px-4 p-2 rounded-xl border border-beige justify-center items-center flex hover:bg-beige active:bg-yellow">
            <div className="text-black text-lg font-medium font-['Poppins']">Romance</div>
            </button>
            ...
            <div className="text-black text-left text-2xl font-semibold font-['Poppins'] capitalize mt-10 -mb-1"> Recommendations for You</div>
                ...
                <div className="flex gap-11">
                    {recommendations.map((recommendation) => (
                        ...
                        <div className="flex flex-col items-right justify-start gap-2">
                            <img src={recommendation.coverImage} className="w-[145px] h-[166px] rounded"></img>
