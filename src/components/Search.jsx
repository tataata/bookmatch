...
const Search = () => {
    return (
        <>
            <Link to="/bookswipe" className="pt-3 flex items-center gap-1 ml-20 text-black text-xl font-medium  font-['Lora'] hover:text-red active:text-blue">
        ...
        <div className="flex flex-col gap-4 justify-center items-center">
            <div className="flex flex-col items-center justify-center gap-3 w-[900px]">
            <input
              id="search"
            ...
            <div className="text-black text-2xl font-semibold font-['Poppins'] text-left">Recent Searches</div>
            <div className="text-black text-xl font-medium font-['Lora'] text-left">Dystopian Novels</div>
            <div className="text-black text-xl font-medium font-['Lora'] text-left">Isaac Asimov</div>
            <div className="text-black text-xl font-medium font-['Lora'] text-left">Mystery</div>
            </div>      

            <div className="flex flex-col gap-3 items-start justify-center w-[900px]">
            <div className="text-black text-2xl font-semibold font-['Poppins'] text-left mt-2">Popular Searches</div>
            <div className="grid grid-cols-4 gap-3">
            <div className="px-4 p-2 rounded-xl border border-beige justify-center items-center flex">
            <div className="text-black text-xl font-medium font-['Poppins']">Best Sellers </div>
            </div>
            <div className="px-4 p-2 rounded-xl border border-beige justify-center items-center flex">
            <div className="text-black text-xl font-medium font-['Poppins']">New Releases</div>
            </div>
            <div className="px-4 p-2 rounded-xl border border-beige justify-center items-center flex">
            <div className="text-black text-xl font-medium font-['Poppins']">Award Winners</div>
            </div>
            <div className="px-4 p-2 rounded-xl border border-beige justify-center items-center flex">
            <div className="text-black text-xl font-medium font-['Poppins']">Classic Fiction</div>
            </div>
            <div className="px-4 p-2 rounded-xl border border-beige justify-center items-center flex">
            <div className="text-black text-xl font-medium font-['Poppins']">Adventure</div>
            </div>
            <div className="px-4 p-2 rounded-xl border border-beige justify-center items-center flex">
            <div className="text-black text-xl font-medium font-['Poppins']">Romance</div>
            </div>

            <button className="text-blue text-xl font-medium font-['Poppins'] hover:text-red active:text-yellow">More</button>
            </div>
            </div>   
            
            <div className="text-black text-left text-2xl font-semibold font-['Poppins'] capitalize mt-10"> Recommendations for You</div>

            <div className="w-[900px]">
                <div className="flex gap-11">
                    {recommendations.map((recommendation) => (
                        <Link key={recommendation.title} to={`/bookinfo/${recommendation.title}`}>
                        <div className={`flex flex-col items-right justify-start gap-2`}>
                            <div className={`w-[145px] h-[166px] ${recommendation.coverImage} rounded`}></div>
                ...
                <div className="mt-3 cursor-pointer flex justify-end w-[900px] mb-14">
