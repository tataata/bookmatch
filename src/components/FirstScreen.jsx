    ...
    <div className="flex flex-col items-center gap-10 absolute top-[320px] left-0 right-0">
      ...
      <div className="relative w-[560px] h-20">
        <div className="absolute top-0 left-0 text-center text-black text-3xl font-medium font-['Lora'] leading-10">
          <span className="font-semibold font-['Poppins'] ">BookMatch </span> 
          helps you find the best books based on your interests
        </div>
      </div>
      <div className="mt-5">

      <Link href="/signup" className="px-24 py-4 bg-blue rounded-full flex justify-center items-center gap-2.5  hover:bg-red active:bg-red active:ring active:ring-yellow">
