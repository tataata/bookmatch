...
const HeaderMenu = () => {
  return (
    <>
      <div className="w-full h-24 bg-stone flex items-center justify-between px-20">
        <div className="flex items-center">
          <Link href="/bookswipe" className="left-[80px] top-[12px] absolute">
            <img
        ...
        <div className="flex items-center gap-10 mt-1">
          <div className="flex items-center gap-8">
            <Link
              href="/bookswipe"
              className="text-black text-xl font-semibold font-['Poppins'] hover:text-red active:text-blue"
            >
              Discover
            </Link>
            <Link
          ...
          <div className="flex flex-row items-center justify-center gap-3">
            ...
            <Link href="/profile">
              <img
                className="w-10 h-10 border-2 border-yellow hover:border-red active:border-blue rounded-full"
