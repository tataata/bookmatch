    ...
    return (
        <>
            ...
            <div className="mt-6 flex flex-col justify-center items-center">
                {canProceed ? (
                    <Link href="/interests" className="px-40 py-4 bg-blue rounded-full flex justify-center items-center hover:bg-red active:bg-red active:ring active:ring-yellow">
